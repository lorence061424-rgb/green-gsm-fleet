...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $vehicles = [
            ...
            [
                'license_plate' => 'EV-8088',
                'make' => 'VinFast',
                'model' => 'VF 8 Electric SUV',
                'year' => 2026,
                'type' => 'Electric Vehicle (EV)',
                'status' => 'active',
                'fuel_capacity' => 87.7,
                'current_gps_lat' => 14.5800,
                'current_gps_lng' => 121.0000,
            ],
            [
                'license_plate' => 'EV-3091',
                'make' => 'Nerio',
                'model' => 'Green Taxi EV',
                'year' => 2026,
                'type' => 'Electric Vehicle (EV)',
                'status' => 'active',
                'fuel_capacity' => 54.0,
                'current_gps_lat' => 14.5500,
                'current_gps_lng' => 121.0200,
            ],
            [
                'license_plate' => 'MPV-7740',
                'make' => 'BYD',
                'model' => 'M6 Electric MPV',
                'year' => 2026,
                'type' => 'MPV / SUV',
                'status' => 'active',
                'fuel_capacity' => 71.8,
                'current_gps_lat' => 14.5900,
                'current_gps_lng' => 120.9700,
            ],
            [
                'license_plate' => 'VAN-6012',
                'make' => 'Nissan',
                'model' => 'NV350 Urvan Shuttle',
                'year' => 2025,
                'type' => 'Shuttle Van',
                'status' => 'active',
                'fuel_capacity' => 65.0,
                'current_gps_lat' => 14.5600,
                'current_gps_lng' => 121.0400,
            ],
            [
                'license_plate' => 'TXI-4490',
                'make' => 'MG',
                'model' => 'MG 5 Hirna Taxi',
                'year' => 2026,
                'type' => 'Taxi Sedan',
                'status' => 'active',
                'fuel_capacity' => 45.0,
                'current_gps_lat' => 14.5700,
                'current_gps_lng' => 120.9900,
            ]
        ];
